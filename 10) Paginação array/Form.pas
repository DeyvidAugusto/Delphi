...
uses
  ...
  Dialogs, StdCtrls, Paginador, GeradorLista, Ordenador, Cronometro;
...
begin
  ...
  ListaOrdenada := TOrdenador.Ordenar(FLista, Crescente, Crono);
  FreeAndNil(FLista);

  FLista := ListaOrdenada;
  FPaginador.CarregarLista(FLista);
