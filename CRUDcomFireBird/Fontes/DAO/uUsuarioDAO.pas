...
uses SqlExpr, DB, SimpleDS, SysUtils;
...
type
  ...
  public
    ...
    function IDDisponivel(AID: Integer): Boolean;
    procedure Inserir(ID: Integer; Nome, CPF, Telefone,
                      Nascimento, EstadoCivil, Endereco: string);
    procedure Deletar(AID: Integer);
    function CarregarTodos: TSQLQuery;
  end;

implementation

constructor TUsuarioDAO.Create(AConn: TSQLConnection);
begin
  FConn := AConn;
end;

function TUsuarioDAO.NovaQuery: TSQLQuery;
begin
...
function TUsuarioDAO.IDDisponivel(AID: Integer): Boolean;
var Q: TSQLQuery;
begin
  Q := NovaQuery;
  try
...
procedure TUsuarioDAO.Inserir(ID: Integer; Nome, CPF, Telefone,
                               Nascimento, EstadoCivil, Endereco: string);
var Q: TSQLQuery;
begin
  Q := NovaQuery;
...
function TUsuarioDAO.CarregarTodos: TSQLQuery;
begin
  Result := NovaQuery;
