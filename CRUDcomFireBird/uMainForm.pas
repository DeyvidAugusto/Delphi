...
uses
  ...
  DBClient, SimpleDS, uCadastroForm;
...
begin
  ...
  SQLConnectionDb.LibraryName    := 'dbxint30.dll';
  SQLConnectionDb.VendorLib      := 'fbclient.dll';

  SQLConnectionDb.Params.Clear;
  SQLConnectionDb.Params.Values['Database']    := 'localhost/3050:' + FILEPATH + 'Database\SISTEMA.FDB';
  ...
  SQLConnectionDb.Params.Values['SQLDialect']  := '3';
...
begin
   uCadastroForm.Form2.Position := poScreenCenter;
   uCadastroForm.Form2.Show;
end;
